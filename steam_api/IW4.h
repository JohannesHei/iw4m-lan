...
// search for problematic windowDef_t;
...
typedef struct
{
		...
		// PROBLEMATIC PART START
		// 22
		short unknown8;
		vec4_t rect2;
		char pad[8];
		// from new; only - char pad[2];
        // 24
		// if this is enabled PatchMW2Interface doesn't work...LAME 'n stupido...
        //float originX;
        //float originY;
		// 32 
		// if this is enabled, game crashes
		// but PatchMW2Interface doesn't work...LAME 'n stupido...
		//char pad2[12];
		// 44
		// if this is enabled PatchMW2Interface doesn't work...LAME 'n stupido...
		//char* group;
